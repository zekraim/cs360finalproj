function disp_sections(relation, input, steps, done, feedback, alldone, k_form, k_disp, k_correct){
    ...
    for(let d of done){
        ...
        hide_form('key_feedback_'.concat(d[0]));
    }
            ...
            if (k_disp){
                ...
                if (k_correct){
                    ...
                    for(let f of feedback){
                        ...
                        show_form('key_feedback_'.concat(f[0]));
