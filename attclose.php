...
if ($student_done){ // begin grading process
    $correct_closure = sort_str($closure_sols[0]["CLOSURE"]);
    if (sort_str($student_done_mysqli[0]['FD_RIGHT']) == $correct_closure){
...
$json = json_encode(array($relation, $input, $attribute, $steps, $student_done, $correct));
...
<html>
    ...
    <body onload="disp_sections(display_data[0], display_data[1], display_data[2], display_data[3], display_data[4], display_data[5])">
        <div class="topnav">
        ...
        <div>
            ...
            <div id="input_form">
                <p>
                    ...
                    functional dependency. The colon separates functional dependencies. Only use characters that you defined in the relation scheme above.
                    Any attributes not included in the relation scheme will be ignored.
                </p>
