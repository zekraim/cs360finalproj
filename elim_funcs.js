function disp_sections(relation,input, tree_disp, tree_form, candidates_form, candidates_disp, feedback_correct, feedback_incorrect){
    hide_form('relation_disp');
    hide_form('input_form');
    hide_form('input_disp');
    ...
    if (relation){
        show_form('relation_disp');
        show_form('input_form');
    }
    if(input){
        show_form('input_disp');
    }
    if(tree_disp){
